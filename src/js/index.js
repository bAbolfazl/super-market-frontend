const main = () => {
  ...
  const leftCartDesktop_Btn = document.querySelector('.left-cart--desktop__btn')
  const leftCartDesktop_Btn_close = document.querySelector('#left-cart--desktop__btn--close')

  const bottomCartMobileCont = document.querySelector('#bottom-cart--mobile_cont')
  const bottomCartMobile = document.querySelector('.bottom-cart--mobile')
  const bottomMenuMobile_btn = document.querySelector('#bottom-menu--mobile_btn')
  const bottomCartMobile_btn_close = document.querySelector('#bottom-cart--mobile__btn--close')
  ...
  // events
  leftCartDesktop_Btn_close.addEventListener('click', handle_leftCartDesktop_Btn_close_click)
  ...
  rightMenuDesktop_Btn.addEventListener('click', handle_rightMenuDesktop_btn_click)
